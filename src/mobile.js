    ...
    render(){
        ...
        <div className="bg-white max-w-sm rounded-2xl w-full shadow-2xl">
            <div className="p-8 pt-4 pb-4">
                ...
                <p className="text-sm mt-2">An OTP is sent to your mobile</p>
                <p id="samplephone" className="text-Text_blue text-sm">+91 82534 76354</p>
            </div>
            <div>
                <div className="bg-white m-8 mt-0 mb-0 rounded-b-xl">
                    ...
                    <div className="pl-2 mt-14 text-center">
                        <label for="remember_me" className="text-Text_blue underline"> Try using Email </label>
                    </div>
