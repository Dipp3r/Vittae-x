...
import ReferralComp from "@pages/dashboard/referrals";
import EarningsComp from "@pages/dashboard/earnings";
      ...
      <BrowserRouter history={HashRouter}>
        <Routes history={HashRouter}>
          ...
          <Route
            ...
            index
            element={
              <SigninComp getItem={this.getItem} setItem={this.setItem} />
            }
          />
          <Route
            path="/mobileSignUp"
            element={<SignUpMobComp setItem={this.setItem} />}
          />
          <Route
            path="/signUpOTP"
            element={
              <SignUpOTP getItem={this.getItem} setItem={this.setItem} />
            }
          />
          <Route
            path="/register"
            element={
              <SignupComp getItem={this.getItem} setItem={this.setItem} />
            }
          />
          <Route
            path="/termsAndConditions"
            element={<TermsAndConditionsComp />}
          />

          <Route
            path="/forgotPassword"
            element={<ForgotPassword setItem={this.setItem} />}
          />
          <Route
            path="/forgotOTP"
            element={
              <ForgotOTP getItem={this.getItem} setItem={this.setItem} />
            }
          />
          <Route
            path="/newPass"
            element={
              <NewPasswordComp getItem={this.getItem} setItem={this.setItem} />
            }
          />
          ...
          <Route
            path="/dashboard"
            element={
              <DashboardComp getItem={this.getItem} setItem={this.setItem} />
            }
          />
          <Route path="/referrals" element={<ReferralComp />} />
          <Route path="/earnings" element={<EarningsComp />} />
          <Route path="/notification" element={<NotificationComp />} />

          <Route
            path="/profile"
            element={<Profile getItem={this.getItem} setItem={this.setItem} />}
          />
          <Route
            path="/profileinfo"
            element={
              <ProfileInfo getItem={this.getItem} setItem={this.setItem} />
            }
          />
          <Route
            path="/monthlyview"
            element={
              <MonthlyView getItem={this.getItem} setItem={this.setItem} />
            }
          />
          <Route
            path="/tasks"
            element={<Tasks getItem={this.getItem} setItem={this.setItem} />}
          />

          <Route
            path="/customerview"
            element={
              <CustomerView getItem={this.getItem} setItem={this.setItem} />
            }
          />
        </Routes>
      </BrowserRouter>
