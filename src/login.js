            ...
            <div>
                <div className="bg-white m-8 mt-0 mb-0 rounded-b-xl">
                    ...
                    <div>
                        ...
                        <input type="text" onChange={this.changeInVal} placeholder="example@gmail.com" name='userID' className=" font-thin rounded-md p-2 w-full"/>
                    </div>

                    <div className="pt-5">
                        <p className="text-Text_blue text-sm p-2">Password</p>
                        <div className="flex-row flex border-2 border-border_gray rounded-md">
                            <input type="password" onChange={this.changeInVal}  placeholder="Example123" name='password' className="password font-thin rounded-md p-2 w-full"/>
                    ...
                    <div className="mt-1">
                        <button id="button" style={{"margin":"0px"}} onClick={this.submit} value="./register" className="bg-gradient-to-r text-white font-normal text-md text-center p-2 from-Vittae_Blue/90 to-Vittae_Red/90 via-Vittae_Violet/90 w-full h-12 rounded-xl">
                            SIGN IN
                        </button>
