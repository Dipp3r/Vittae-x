...
class SignupComp extends React.Component {
  ...
  componentDidMount() {
    ...
    this.submitLink =
      ...
      `/set-password/${this.props.getItem("id")}/`;
  }
  render() {
    // //console.log(this.state)
    return (
        ...
        <div id="SignUpFormDiv">
          ...
          <div id="fieldBox">
            ...
            <input
              ...
              onFocus={() => this.changeColor("#firstNameIn", "#223F80")}
              onBlur={() => this.changeColor("#firstNameIn", "#b8b8b8")}
            />
            ...
            <input
              ...
              name="last_name"
              onKeyDown={this.changeInVal}
              onFocus={() => this.changeColor("#secondNameIn", "#223F80")}
              onBlur={() => this.changeColor("#secondNameIn", "#b8b8b8")}
            />
            ...
            <input
              ...
              name="mail"
              onKeyDown={this.changeInVal}
              onFocus={() => this.changeColor("#mailIn", "#223F80")}
              onBlur={() => this.changeColor("#mailIn", "#b8b8b8")}
            />
            ...
            <div className="tickBox">
              ...
              <button
                ...
                onClick={this.changeTAndC}
              >
                <svg width="10" height="10" viewBox="0 0 15 14" fill="none">
                  <path
                    d="M1.5 8L6.5 12.5L13.5 1.5"
                    stroke="white"
                    strokeWidth="3"
                    strokeLinecap="round"
            ...
            <p id="invalidTC" className="invalid">
              {this.state.tAndCErr}
            </p>
