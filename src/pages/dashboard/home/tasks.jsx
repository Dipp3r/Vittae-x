        ...
        overDue: [
          {
            ...
            name: "AAA",
            due: "2",
            date: "Feb 1, 2023, 12:00 PM",
          },
          {
            title: "Follow up call",
            name: "AAA",
            due: "2",
            date: "Feb 2, 2023, 00:00",
          },
          {
            title: "Follow up call",
            name: "AAA",
            due: "2",
            date: "Feb 3, 2023, 05:00 PM",
          },
          {
            title: "Follow up call",
            name: "AAA",
            due: "2",
            date: "Thu Feb 9, 2023, 05:00 PM",
          },
          {
            title: "Follow up call",
            name: "AAA",
        ...
        upComing: [
          {
            ...
            name: "AAA",
            due: "2",
            date: "Mar 20, 2023, 12:00 PM",
          },
          {
            title: "Follow up call",
            name: "AAA",
            due: "2",
            date: "Nov 2, 2023, 00:00",
          },
        ],
        completed: [
          {
            ...
            name: "AAA",
            due: "2",
            date: "Feb 9, 2023, 12:00 PM",
          },
          {
            title: "Follow up call",
            name: "AAA",
            due: "2",
            date: "Feb 1, 2023, 00:00",
          },
        ],
      },
    };
  ...
  componentDidMount() {
    fetch(import.meta.env.VITE_SECONDARY_SERVER_URL + "/getTasksAll", {
      ...
      .then((data) => {
        //console.log(data);
        this.setState(
          { lastSession: document.querySelector(".statusButton"), data: data },
          () => {
    ...
    return (
      <section id="Tasks">
        ...
        <div id="statusBar">
          <div id="statusButton">
            <button
              ...
              name="0"
              onClick={this.changeCurrentSection}
              style={{
                color: "rgba(34, 63, 128, 1)",
                borderBottomColor: "rgba(34, 63, 128, 1)",
              }}
            >
              overDue{" "}
              {this.state.data.overDue.length > 0
                ? `(${this.state.data.overDue.length})`
                : ""}
            </button>
            <button
              className="statusButton"
            ...
            >
              Upcoming{" "}
              {this.state.data.upComing.length > 0
            ...
            >
              Completed{" "}
              {this.state.data.completed.length > 0
                ? `(${this.state.data.completed.length})`
                : ""}
            </button>
          </div>
        </div>
        ...
        <div id="main">
          ...
          {this.state.snoozeTaskMenu === "flex" ? (
            <SnoozeMenu
